...
function toNumber(value, def) {
  ...
  return converted === Number(value) ? converted : def;
}
...
function getFloatOnString(str) {
  ...
  if (num.toString() !== str.trim().slice(0, num.toString().length)) {
    return NaN;
  }
  return num;
}
...
function getIntegerOnString(str, base) {
  ...
  if (num.toString(base) !== str.trim().slice(0, num.toString(base).length)) {
    return NaN;
  }
  return num;
}
